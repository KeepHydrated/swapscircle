-- Add strike tracking to profiles table
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS strikes_count INTEGER DEFAULT 0;

-- Add indexes for better performance
CREATE INDEX IF NOT EXISTS idx_profiles_strikes_count ON profiles(strikes_count);

-- Create function to increment user strikes and check for suspension
...
-- Create function to send violation notification
