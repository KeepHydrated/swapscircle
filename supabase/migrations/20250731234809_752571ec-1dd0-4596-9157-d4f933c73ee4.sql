-- More thorough cleanup - delete all data for user specifically
-- Get the current user ID and delete all related data

-- Delete all liked items for this specific user
