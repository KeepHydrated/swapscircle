...
-- Update friend_requests table to match expected schema
...
-- Create trade_messages table (using messages table but adding alias for compatibility)
-- We already have messages table, just need to make sure it has the right structure
