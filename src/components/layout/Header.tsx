...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-0 z-[9999] w-full bg-white border-b border-gray-200 shadow-sm pointer-events-auto overflow-visible transform-gpu will-change-transform">
            ...
            {!isMobile && (
              <form onSubmit={handleSearch} className="relative ml-6">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 w-64 border border-border rounded-lg bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-border"
                />
              </form>
            )}
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            {user ? (
              isMobile ? (
                ...
                >
                  <Avatar className="h-8 w-8 border-2 border-trademate-blue">
                    {user?.avatar_url ? (
