...
const SAMPLE_MATCHES: MatchItem[] = [
  ...
  },
  {
    ...
    myItemId: 'my-sample-6',
    myItemName: 'LED Floor Lamp',
    myItemImage: 'https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=100&h=100&fit=crop',
  },
  {
    id: 'sample-7',
    name: 'Mountain Bike',
    ...
    description: '21-speed mountain bike, recently tuned',
    myItemId: 'my-sample-7',
    myItemName: 'Road Bike',
    myItemImage: 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=100&h=100&fit=crop',
  },
  {
    id: 'sample-8',
    ...
    description: 'Working Olivetti typewriter from the 1970s',
    myItemId: 'my-sample-8',
    myItemName: 'Mechanical Keyboard',
    myItemImage: 'https://images.unsplash.com/photo-1618384887929-16ec33fab9ef?w=100&h=100&fit=crop',
  },
  {
    id: 'sample-9',
    ...
    description: 'Ray-Ban Wayfarer sunglasses with case',
    myItemId: 'my-sample-9',
    myItemName: 'Aviator Sunglasses',
    myItemImage: 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=100&h=100&fit=crop',
  },
  {
    id: 'sample-10',
    name: 'Camping Tent',
    ...
    myItemId: 'my-sample-10',
    myItemName: 'Hiking Backpack',
    myItemImage: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=100&h=100&fit=crop',
  },
  {
    id: 'sample-11',
    name: 'Vintage Watch',
    ...
    condition: 'Good',
    category: 'Accessories',
    description: 'Classic mechanical watch, keeps perfect time',
    myItemId: 'my-sample-11',
    myItemName: 'Smart Watch',
    myItemImage: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=100&h=100&fit=crop',
  },
  {
    id: 'sample-12',
    ...
    condition: 'Good',
    category: 'Home & Garden',
    description: 'Stunning art deco wall mirror with gold frame',
    myItemId: 'my-sample-12',
    myItemName: 'Modern Mirror',
    myItemImage: 'https://images.unsplash.com/photo-1622556498246-755f44ca76f3?w=100&h=100&fit=crop',
  },
];
