...
const TradeDetailsTabs: React.FC<TradeDetailsTabsProps> = ({
  ...
  return (
    <div className="p-4 border-b border-gray-200 bg-white flex flex-col h-full">
      ...
      <Tabs value={selectedItem} onValueChange={(value) => onSelectItem(value as 'item1' | 'item2')} className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex flex-col">
          <TabsContent value="item1" className="mt-4 flex-1">
          ...
          <TabsContent value="item2" className="mt-4 flex-1">
            <div className="bg-gray-50 rounded-lg p-3 border">
              <div className="flex items-center mb-3">
                <Avatar className="h-12 w-12 bg-gray-100 mr-3 flex-shrink-0">
