            ...
            >
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <div className="message-avatar-border h-12 w-12 overflow-hidden rounded-full bg-transparent shadow-none ring-0">
                    {conversation.otherUserProfile?.avatar_url ? (
                      ...
                      <div className={`flex h-full w-full items-center justify-center rounded-full font-bold shadow-none ring-0 ${conversation.isSupport ? 'bg-primary text-primary-foreground' : 'bg-transparent text-foreground'}`}>
