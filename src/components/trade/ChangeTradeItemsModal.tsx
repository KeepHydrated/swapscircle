...
const ChangeTradeItemsModal: React.FC<ChangeTradeItemsModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-4xl w-[95vw] max-h-[85vh] flex flex-col p-0 overflow-hidden my-4 [&>button]:hidden">
        ...
        {/* Content - Scrollable */}
        <div className="flex-1 overflow-y-auto px-4 sm:px-6 pt-2 pb-4 sm:pb-6 min-h-0">
          {loading ? (
