...
import { X, Heart, ArrowLeft, ArrowRight, Tag, Camera, Shield, DollarSign, Repeat, Check } from "lucide-react";
              ...
              <>
                ...
                {showProfileInfo && userProfile && (
                  <div className="flex gap-3 items-center mt-auto pt-6 border-t border-gray-200 bg-gray-50 p-4 -mx-8 -mb-7">
                    <div className="w-11 h-11 rounded-full border border-profile-icon-border cursor-pointer overflow-hidden" onClick={handleProfileClick}>
