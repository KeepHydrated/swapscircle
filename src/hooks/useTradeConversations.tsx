  ...
  useEffect(() => {
    const loadTradeConversations = async () => {
      ...
      try {
        ...
        // Add test conversation for nadiachibri@gmail.com
        const { data: currentUser } = await supabase.auth.getUser();
        if (currentUser?.user?.email === 'nadiachibri@gmail.com') {
          const testConversation: ConversationDisplay = {
            id: 'test-conversation-123',
            name: 'Alex Johnson',
            lastMessage: 'Hey! I\'m interested in trading my vintage camera for your vinyl record collection. What do you think?',
            time: '2m ago',
            rating: 4.8,
            ...
            otherUserProfile: {
              ...
              bio: 'Photography enthusiast and vinyl collector',
          ...
          const testExchangePair: ExchangePairDisplay = {
            id: 999,
            item1: {
              ...
              image_urls: ['https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400&h=300&fit=crop'],
              description: 'Rare collection of jazz and rock vinyl records from the 70s and 80s',
              category: 'Music',
              condition: 'Very Good',
              price_range_min: 150,
              price_range_max: 300,
              tags: ['vintage', 'music', 'collectible']
            },
            item2: {
            ...
            partnerId: 'test-conversation-123',
            partnerProfile: {
              id: 'test-user-456',
              username: 'alexjohnson',
              avatar_url: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face',
          ...
          // Add test data to the beginning of arrays
          displayConversations.unshift(testConversation);
          displayExchangePairs.unshift(testExchangePair);
        }
